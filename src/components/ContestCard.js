...
const ContestCard = ({
  ...
  return Number(contest?.max_entries) - Number(contest?.current_entries) ? (
    <View>
      {!hideTitle ? (
      ...
      <View
        ...
        <>
          ...
          <View
            ...
            <Text
              style={{color: '#fff', fontSize: 10, fontFamily: 'Inter-Medium'}}>
