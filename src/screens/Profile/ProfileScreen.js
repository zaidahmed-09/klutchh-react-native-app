...
const ProfileScreen = ({navigation}) => {
  ...
  const addMoneyToWallet = () => {
    if (+amountToAdd > 0)
      Linking.openURL(
        `http://payments.klutchh.in/addMoney?amount=${amountToAdd}&token=${auth.access_token}`,
      );
  };
          ...
          <View>
            <View
              ...
              <View
                ...
                <Image
                  source={{
                    uri: `data:image/image/png;base64,${auth?.user?.avatar_id?.avatar_data.toString(
                      'base64',
                    )}`,
                  }}
            ...
            <View
              ...
              <View
                style={[
                  styles.cardSubHeadingContainer,
                  {
                    alignItems: 'center',
                    justifyContent: 'space-between',
                    flexDirection: 'row',
                ...
                <View
                  ...
                  <View style={styles.statsBox}>
                    ...
                    <Text
                      ...
                      {auth?.user?.contests_won ? auth?.user?.contests_won : 0}
                    </Text>
                  </View>
                  <View style={styles.statsBox}>
                    <Image
                    ...
                    <Text
                      ...
                      ₹{' '}
                      {auth?.user?.totalAmountWon
                        ? auth?.user?.totalAmountWon.toFixed(2)
                        : 0}
                    </Text>
                  </View>
                </View>
